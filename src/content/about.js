...
const about = {
  ...
  paragraphs: [
    "Excel Amadi is a science-focused student, technology enthusiast, and digital creator with an interest in photography, visual editing, web development, and creative digital projects.",
    "Excel uses Lightroom Mobile to experiment with color, lighting, composition, and photographic style.",
  ],
